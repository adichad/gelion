...
import json
from tools import MSSQLDB, MySQLDB, Encoder, GroceryOrdersDeltaUpdater
...
try:
  ...
  deltaUpdater = GroceryOrdersDeltaUpdater(db_source, db_target, db_orders, queryMap, range)
