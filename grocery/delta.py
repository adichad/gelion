...
import json
from tools import MSSQLDB, MySQLDB, Encoder, GroceryDeltaUpdater
...
try:
  ...
  deltaUpdater = GroceryDeltaUpdater(db_source, db_target, queryMap, range)
