...
import json
from tools import PostgreSQLDB, MySQLDB, GeoShaper, MandelbrotPipe
...
if __name__ == '__main__':
  ...
  pid = str(os.getpid())
  pidfile = "/tmp/etl.geo.%(env)s.%(proc_id)i-%(procs)i.pid"%locals()
  ...
  try:
    ...
    shaper = GeoShaper(db_source, queryMap)
