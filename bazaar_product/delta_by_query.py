...
import json
from tools import MySQLDB, Encoder, ProductCustomDeltaUpdater
...
try:
  ...
  deltaUpdater = ProductCustomDeltaUpdater(db_source, db_target, queryMap, range)
